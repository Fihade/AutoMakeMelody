...
public class MetaMessage implements MidiMessage {
	...
	public static final byte META_STATUS_BYTE = (byte) 0xFF;
	...
	public static int getDenominator(int denominator) {
		int exponent = 0;
	...
	public enum Type {
		END_OF_TRACK(47), TEXT(1), LYRIC_TEXT(5), MARKER_TEXT(6), TEMPO(81), TIME_SIGNATURE(88);
